<div class="wrapper wrapper-content animated fadeInRight" id="periodeContainer">
    <form opd="form" id="mahasiswaalumni_form" onsubmit="return false;" type="multipart" autocomplete="off">
        ...
        <input type="hidden" id="nim" name="nim" value="<?=$contentData['nim']?>">
...
<script>
    $(document).ready(function() {
        ...
        function getMahasiswaSelf() {
            ...
            swal.showLoading();
            return $.ajax({
                url: `<?php echo site_url('MahasiswaAlumniController/getMahasiswaSelfSkripsiAdmin/') ?>`,
                'type': 'POST',
                data: { nim : '<?=$contentData['nim']?>'},
        ...
        MahasiswaAlumniModal.form.submit(function(event) {
            ...
            var url = "<?= site_url('MahasiswaAlumniController/editSelfSkripsiAdmin') ?>";
