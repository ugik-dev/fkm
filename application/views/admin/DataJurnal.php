    ...
    <div hidden class="ibox ssection-container">
        <div class="ibox-content">
            <form class="form-inline" id="toolbar_form" onsubmit="return false;">
                <button hidden type="button" class="btn btn-success my-1 mr-sm-2" id="new_btn" disabled="disabled"><i class="fal fa-plus"></i> Tambah Jurnal</button>
            </form>
        </div>
    </div>
    ...
    $(document).ready(function() {
        ...
        function getAllStrukturMahasiswaAlumni() {
            ...
            return $.ajax({
                ...
                'type': 'POST',
                data: {id_mahasiswaalumni: '<?=$contentData['id_mahasiswaalumni']?>'},
