                ...
                <div class="post-content-wrapper">
                    <div class="post-content">
                        <div class="entry-content">
                            <h1 class="text-center"><?= $dataSkripsi['judul_skripsi'] ?></h1>
                            <br>
                            <h4>
                                Author : <?= $dataSkripsi['nama'] ?> - <?= $dataSkripsi['nama_prodi'] ?>
                            </h4>
                            <h4>
                                Year : <?= $dataSkripsi['tahun_skripsi'] ?>
                            </h4>
                            <div class="col-md-9">
                                <h2>Abstrak</h2>
                                ...
                                <blockquote>
                                    <p><?= $dataSkripsi['abstrak_en'] ?></p>
                                </blockquote>
                                <?php if (!empty($this->session->userdata()['username'])) { ?>
                                    <?php if (!empty($dataSkripsi['skripsi'])) { ?>

                                        <embed type="application/pdf" src="<?= base_url('uploads/skripsi/') . $dataSkripsi['skripsi'] ?>" width="100%" height="400"></embed>
                                    <?php  } ?>

                                    <br>
                                    <?php if (!empty($dataSkripsi['skripsi_en'])) { ?>

                                        <embed type="application/pdf" src="<?= base_url('uploads/skripsi_en/') . $dataSkripsi['skripsi_en'] ?>" width="100%" height="400"></embed>
                                    <?php  } ?>

                                <?php } else { ?>
                                    <p>Harap login untuk melihat full dokument.</p>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="post-social-wrapper">
                                ...
                                <div class="clear"></div>
                                <span class="tags"> Keyword:&nbsp; <a el="tag"><?= $dataSkripsi['keyword'] ?></a></span>
