            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div id="post-31" class="article-frame post-31 page type-page status-publish hentry">
                        <?php if ($_COOKIE['lang_set'] == 'in') { ?>
                            <h1 class="entry-title  hidden-lg hidden-md"><a href="" title="Alumni">Alumni</a></h1>
                        <?php } else { ?>
                            <h1 class="entry-title  hidden-lg hidden-md"><a href="" title="Alumni">Alumni</a></h1>
                        <?php }; ?>
                        <div class="entry-content">
                            ...
                            <form role="search" method="get" class="search-form input-group" id="src_mhs" action="javascript:void(0);">
                                    <input type="text" class="search-field form-control" placeholder="Search …" value="" name="search_alumni" title="Cari Alumni" />
            ...
            Object.values(data).forEach((d) => {
                ...
                tmp = `<tr>
                                            ...
                                            Tahun masuk :    ${d['tahun_masuk']} <br>
                                             ${d['tahun_keluar'] ? 'Tahun keluar : '+d['tahun_keluar']+' <br>' : ''}
                                            ${d['deskripsi']}
                                            </td>
