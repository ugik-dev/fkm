    ...
    <div class="container">
      <div class="page-header-title">
        <?php if ($_COOKIE['lang_set'] == 'in') { ?>
          <h1 class="entry-title"><a href="<?= base_url() ?>" title="Penelitian">Penelitian</a></h1>
        <?php } else { ?>
          <h1 class="entry-title"><a href="<?= base_url() ?>" title="Research">Research</a></h1>
        <?php }; ?>
        ...
        <?php if ($_COOKIE['lang_set'] == 'in') { ?>
          <div class="breadcrumb"> <span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Fakultas Ilmu Kesehatan - Universitas Sriwijaya." href="<?= base_url() ?>" class="home"><span property="name">Fakultas Ilmu Kesehatan</span></a>
              <meta property="position" content="1"></span>&nbsp;&nbsp;/&nbsp;&nbsp;<span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="<?= base_url() . '' ?>" href="<?= base_url() . '' ?>" class="post post-page"><span property="name"> Akademik </span></a>
            <?php } else { ?>
              <div class="breadcrumb"> <span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Go to Public Healty Faculty - Sriwijaya University." href="<?= base_url() ?>" class="home"><span property="name">Public Healty Faculty</span></a>
                  <meta property="position" content="1"></span>&nbsp;&nbsp;/&nbsp;&nbsp;<span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="<?= base_url() . '/' ?>" href="<?= base_url() . '/' ?>" class="post post-page"><span property="name"> Academic </span></a>
                <?php }; ?>
              </div>
          </div>
  </section>
      ...
      <div class="row">
        <div class="col-md-8 col-sm-8 col-xs-12">
          ...
          <div id="post-31" class="article-frame post-31 page type-page status-publish hentry">
            <?php if ($_COOKIE['lang_set'] == 'in') { ?>
              <h1 class="entry-title  hidden-lg hidden-md"><a href="" title="Penelitian">Penelitian</a></h1>
            <?php } else { ?>
              <h1 class="entry-title  hidden-lg hidden-md"><a href="" title="Research">Research</a></h1>
            <?php }; ?>
        ...
        <?php $this->load->view('public/fragment/slidebarAcademy') ?>
      </div>
    </div>
  </section>
  <style>
  ...
  $(document).ready(function() {
    ...
    function renderPaggination(data) {
      ...
      if (page > 1) {
        ...
        html_tmp = `<li class="page-item"><span class="page-link"><a href="<?= base_url() ?>about/research?page=${page-1}">Prev</a></span></li>
        `;
      }
      ...
      for (i = 1; i <= jumlah; i++) {
        if (page == i) {
          ...
          html_tmp += ` <li class="page-item"><span class="page-link"><a href="<?= base_url() ?>about/research?page=${i}">${i}</a></span></li>
                      `;
        }
      }
      ...
      if (page < jumlah) {
        ...
        html_tmp += `<li class="page-item"><span class="page-link"><a href="<?= base_url() ?>about/research?page=${parseInt(page)+1}">Next</a></span></li>
`;
      }
    ...
    function renderNews(data) {
      ...
      Object.values(data).forEach((news) => {
        img =  news['berita_image'] ? ` <img style="object-fit:cover" data-src="<?= base_url('uploads/berita_image/') ?>${news['berita_image']}" class="lazyload" /> ` : '';
          ...
          news_list.append(`
                       <div class="col-lg-12 "> 
                        ...
                        <div class="col-lg-9  headline-text">
                            ...
                            <h4 class=" headline  trim-text serif " >${ renderDate(news['berita_tanggal'])} </h4>
                            </div>
                            </div>
                    </div>`);
        <?php } else { ?>
          news_list.append(`
                       <div class="col-lg-12 "> 
                        ...
                        <div class="col-lg-9  headline-text">
                            ...
                            <h4 class=" headline  trim-text serif " >${renderDateEn(news['berita_tanggal'])} </h4>
                            </div>
                            </div>
                    </div>`);
        <?php }; ?>
