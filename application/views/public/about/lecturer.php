        ...
        <div class="container">
            <div class="page-header-title">
                <?php if ($_COOKIE['lang_set'] == 'in') { ?>
                    <h1 class="entry-title"><a href="<?= base_url() ?>" title="Struktur Pimpinan">Dosen dan Tenaga Pendidik</a></h1>
                <?php } else { ?>
                    <h1 class="entry-title"><a href="<?= base_url() ?>" title="Leadership Structure">Lecture and Educators</a></h1>
                <?php }; ?>
