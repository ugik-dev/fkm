        ...
        <div class="container">
            <div class="page-header-title">
                <?php if ($_COOKIE['lang_set'] == 'in') { ?>
                    <h1 class="entry-title"><a href="<?= base_url() ?>" title="Struktur Pimpinan">Struktur Pimpinan</a></h1>
                <?php } else { ?>
                    <h1 class="entry-title"><a href="<?= base_url() ?>" title="Leadership Structure">Leadership Structure</a></h1>
                <?php }; ?>
...
<script>
    ...
    $(document).ready(function() {
        ...
        function getAllStrukturPimpinan() {
            ...
            return $.ajax({
                url: `<?php echo site_url('PublicController/getAllPimpinan/') ?>`,
                'type': 'POST',
                data: {},
