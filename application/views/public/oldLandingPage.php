...
<div id="inSlider" class="carousel slide" data-ride="carousel">
  <ol class="carousel-indicators">
    ...
    <!-- <li data-target="#inSlider" data-slide-to="2"> -->
    </li>
  </ol>
  <div class="carousel-inner" role="listbox">
    <div class="carousel-item active">
      <div class="header-back">
        <section class="full-screen home-full" style="top: -220px; position: relative; height: 370px; width: 100%;">
          <section class="home-video">
            <div id="embed-home" class="embed-responsive embed-responsive-16by9 ">
...
<!-- <script>
  function onYouTubeIframeAPIReady() {
    ...
    player = new YT.Player('muteYouTubeVideoPlayer', {
      videoId: 'yjyhqqbFYso', // ID Video Youtube
      width: 640, // panjang video (in px)
      ...
      playerVars: {
        ...
        loop: 10, // Mengulang video setelah selesai
        fs: 0, // Menyembunyikan tombol fullscreen
        cc_load_policty: 0, // Menyembunyikan caption
        siv_load_policy: 3, // Menyembunyikan anotasi
        autohide: 1,
        allowfullscreen: "allowfullscreen" // Menyembunyikan kontrol video
      },
      events: {
        onReady: function(e) {
          e.target.mute();
...
<script>
  $(document).ready(function() {
    ...
    if (lang == 'en') {
      $('#navbar-item').html(`
        <li><a class="nav-link page-scroll" href="#profil">Profile</a></li>
        <li><a class="nav-link page-scroll" href="#akademik">Academy</a></li>
        <li><a class="nav-link page-scroll" href="#administrasi">Adiministration</a></li>
