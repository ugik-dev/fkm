  ...
  <section style="height: 30px;" id="page-header" class="page-header parallax-window section-row hidden-sm hidden-xs" data-parallax="scroll" data-image-src="https://ub.ac.id/wp-content/uploads/2017/09/bg-default.jpg">
    <div class="container">
      <div class="page-header-title">
        <h1 class="entry-title"><a href="<?= base_url() ?>" title="Topik Utama">Topik Utama</a></h1>
        <div class="breadcrumb"> <span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Go to Fakultas Ilmu Kesehatan - Universitas Sriwijaya." href="<?= base_url() ?>" class="home"><span property="name">Fakultas Ilmu Kesehatan</span></a>
            <meta property="position" content="1"></span>&nbsp;&nbsp;/&nbsp;&nbsp;<span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="<?= base_url() . 'hot_news/' ?>" href="<?= base_url() . 'hot_news/' ?>" class="post post-page"><span property="name"> Topik Utama </span></a>
  ...
  $(document).ready(function() {
    ...
    function renderPaggination(data) {
      ...
      if (page > 1) {
        ...
        html_tmp = `<li class="page-item"><span class="page-link"><a href="<?= base_url() ?>hot_news?page=${page-1}">Prev</a></span></li>
        `;
      }
      ...
      for (i = 1; i <= jumlah; i++) {
        ...
        html_tmp += ` <li class="page-item"><span class="page-link"><a href="<?= base_url() ?>hot_news?page=${i}">${i}</a></span></li>
                      `;
                    }
      }
      ...
      if (page < jumlah) {
        ...
        html_tmp += `<li class="page-item"><span class="page-link"><a href="<?= base_url() ?>hot_news?page=${parseInt(page)+1}">Next</a></span></li>
`;
      }
