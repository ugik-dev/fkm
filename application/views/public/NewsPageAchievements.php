  ...
  <section style="height: 30px;" id="page-header" class="page-header parallax-window section-row hidden-sm hidden-xs" data-parallax="scroll" data-image-src="https://ub.ac.id/wp-content/uploads/2017/09/bg-default.jpg">
    <div class="container">
      ...
      <?php if ($_COOKIE['lang_set'] == 'in') { ?>
                    <h1 class="entry-title"><a href="<?= base_url() ?>" title="Struktur Pimpinan">Prestasi</a></h1>
                <?php } else { ?>
                    <h1 class="entry-title"><a href="<?= base_url() ?>" title="Leadership Structure">Achievments</a></h1>
                <?php }; ?>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8 col-sm-8 col-xs-12">
          ...
          <?php if ($_COOKIE['lang_set'] == 'in') { ?>
            <h1 class="entry-title  hidden-lg hidden-md"><a href="" title="Tentang">Tentang</a></h1>       <?php } else { ?>
              <h1 class="entry-title  hidden-lg hidden-md"><a href="" title="About">About</a></h1>     <?php }; ?>
  ...
  $(document).ready(function() {
    ...
    function renderPaggination(data) {
      ...
      if (page > 1) {
        ...
        html_tmp = `<li class="page-item"><span class="page-link"><a href="<?= base_url() ?>about/achievements?page=${page-1}">Prev</a></span></li>
        `;
      }
      ...
      for (i = 1; i <= jumlah; i++) {
        ...
        html_tmp += ` <li class="page-item"><span class="page-link"><a href="<?= base_url() ?>about/achievements?page=${i}">${i}</a></span></li>
                      `;
                    }
      }
      ...
      if (page < jumlah) {
        ...
        html_tmp += `<li class="page-item"><span class="page-link"><a href="<?= base_url() ?>about/achievements?page=${parseInt(page)+1}">Next</a></span></li>
`;
      }
