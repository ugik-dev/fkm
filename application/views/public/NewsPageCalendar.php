    ...
    <div class="container">
      <div class="page-header-title">
        <?php if ($_COOKIE['lang_set'] == 'in') { ?>
          <h1 class="entry-title"><a href="<?= base_url() ?>" title="Kalender Akademik">Kalender Akademik</a></h1>
        <?php } else { ?>
          <h1 class="entry-title"><a href="<?= base_url() ?>" title="Calendar Academic">Calendar Academic</a></h1>
        <?php }; ?>
      ...
      <div class="row">
        <div class="col-md-8 col-sm-8 col-xs-12">
          ...
          <div id="post-31" class="article-frame post-31 page type-page status-publish hentry">
            <?php if ($_COOKIE['lang_set'] == 'in') { ?>
              <h1 class="entry-title  hidden-lg hidden-md"><a href="" title="Kalender Akademik">Kalender Akademik</a></h1>
            <?php } else { ?>
              <h1 class="entry-title  hidden-lg hidden-md"><a href="" title="Calendar Academic">Calendar Academic</a></h1>
            <?php }; ?>
  ...
  $(document).ready(function() {
    ...
    function renderPaggination(data) {
      ...
      if (page > 1) {
        ...
        html_tmp = `<li class="page-item"><span class="page-link"><a href="<?= base_url() ?>about/calendar?page=${page-1}">Prev</a></span></li>
        `;
      }
      ...
      for (i = 1; i <= jumlah; i++) {
        if (page == i) {
          ...
          html_tmp += ` <li class="page-item"><span class="page-link"><a href="<?= base_url() ?>about/calendar?page=${i}">${i}</a></span></li>
                      `;
        }
      }
      ...
      if (page < jumlah) {
        ...
        html_tmp += `<li class="page-item"><span class="page-link"><a href="<?= base_url() ?>about/calendar?page=${parseInt(page)+1}">Next</a></span></li>
      `;
      }
