...
var hAdminBar=0;if(!document.getElementById("#wpadminbar")){var hAdminBar=$("#wpadminbar").height();}
$(".modal-home2 .close-modal").click(function(){$(".modal-home2").remove();});$('#ubDirectory a').click(function(){$(this).tab('show');});$('#tabContent > div:first-child').addClass("in active");$('#ubDirectory > div:first-child').addClass("active");$('#ubModal').on('shown.bs.modal',function(){$('#ubInput').focus();});$('#homeModal').modal('show');$('#tabContent > div:first-child').addClass("in active");$('#ubDirectory > li:first-child').addClass("active");var winWidth=$(window).width();var winHeight=$(window).height();var ubHeader=$(".navbar-top").height()+$(".navbar-main").height();var userAgent=window.navigator.userAgent;if(/Android|webOS|iPhone|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)||userAgent.match(/iPad/i)||userAgent.match(/iPhone/i)){$(".home-video").remove();$(".menu-desc").remove();$("body.home .full-screen").css({"margin-top":0});$(".full-screen").css({"height":"auto"});$(".mobile-slider").css({"height":.75*winHeight});$(".ms-slider-li ").css({"height":.75*winHeight});$(".static-modal").css({"top":70});}else{$(".section-slider").remove();$("body.home .full-screen").css({"top":-120,"position":"relative","margin-bottom":-120});$("#page-header").css({"height":winHeight*.5,"padding-top":winHeight*.33});$(".home-jump").css({"margin-top":-1*$(".home-jump").height()});$(".panel-news").css({"min-height":$(".panel-news").height()+50});$("body.home.page .embed-responsive iframe").css({"margin-top":-35});$(".static-modal").css({"top":160});}
$(".quicklinks-toggle").click(function(){$(".quicklinks-toggle").toggleClass("open");$(".section-quicklinks").toggleClass("open");$(".search-row").removeClass("open");$(".navbar-nav > li").removeClass("open");});$(".search-toggle").click(function(){$(".search-row").toggleClass("open");$(".section-quicklinks").removeClass("open");$(".navbar-nav > li").removeClass("open");});$(".navbar-nav > li").click(function(){$(".search-row").removeClass("open");$(".section-quicklinks").removeClass("open");});$(".quicklinks-close").click(function(){$(".section-quicklinks").removeClass("open");$(".quicklinks-toggle").removeClass("open");});$(".navbar-top ul.menu > li.menu-item-has-children").addClass("dropdown");$(".navbar-top ul.menu > li.menu-item-has-children > a").attr({"data-toggle":"dropdown","aria-haspopup":"true","aria-expanded":"true"});$(".navbar-top ul.menu > li.menu-item-has-children > ul").addClass("dropdown-menu").attr({"role":"menu"});var tag=document.createElement('script');tag.src="https://www.youtube.com/iframe_api";var firstScriptTag=document.getElementsByTagName('script')[0];firstScriptTag.parentNode.insertBefore(tag,firstScriptTag);var player,seconds=0;function onYouTubeIframeAPIReady(){player=new YT.Player('ubPlayer',{height:'360',width:'640',videoId:htmlString,playerVars:{autoplay:1,controls:0,showinfo:0,modestbranding:1,loop:1,fs:0,cc_load_policy:0,iv_load_policy:3,autohide:1,disablekb:1,playlist:htmlString,},events:{'onReady':onPlayerReady,'onStateChange':onPlayerStateChange}});}
function onPlayerReady(event){event.target.playVideo();event.target.mute();}
function onPlayerStateChange(event){}
function stopVideo(){player.stopVideo();}
$(window).scroll(function(){var scroll=$(window).scrollTop();if(scroll>=.25*$(window).height()){$('#ub-header').addClass('nav-scrolled').animate();$('.btt').addClass('show').animate();}else{$('#ub-header').removeClass('nav-scrolled').animate();$('.btt').removeClass('show').animate();event.preventDefault();}});$(".headline-thumbnail .headline-link ").css({"width":$(".headline-thumbnail").width(),"height":$(".headline-thumbnail ").width()/16*9});$('.counter').each(function(){$(this).prop('Counter',0).animate({Counter:$(this).text()},{duration:3200,easing:'swing',step:function(now){$(this).text(Math.ceil(now));}});});$(".menu-desc").css({"width":"33.33%"});var vid=document.getElementById("ubVideo");$('.home-jump li a[href*="#"]').not('[href="#"]').not('[href="#0"]').click(function(event){if(location.pathname.replace(/^\//,'')==this.pathname.replace(/^\//,'')&&location.hostname==this.hostname){var target=$(this.hash);target=target.length?target:$('[name='+this.hash.slice(1)+']');if(target.length){event.preventDefault();$('html, body').animate({scrollTop:target.offset().top-$("#ub-header").height()},1000,function(){});}}});if(window.matchMedia("(orientation: portrait)").matches){$(".full-screen").css({"height":"auto","width":"100%"});}
if(window.matchMedia("(orientation: landscape)").matches){$(".full-screen").css({"height":winHeight-(hAdminBar),"width":"100%"});}
